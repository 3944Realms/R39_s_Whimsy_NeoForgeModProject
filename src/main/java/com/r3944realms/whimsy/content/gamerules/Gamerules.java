package com.r3944realms.whimsy.content.gamerules;
...
public class Gamerules {
    ...
    public static class FloatValue extends GameRules.Value<Gamerules.FloatValue> {
        private float value;
        public static GameRules.Type<Gamerules.FloatValue> create(
