...
public class ModPaintingVariants {
    public static final ResourceKey<PaintingVariant> RANK = create("rank");
    ...
    public static void PaintingVariantBootstrap(BootstrapContext<PaintingVariant> pContext) {
        ModPaintingVariants.register(pContext, ModPaintingVariants.RANK, 1, 2);
    ...
    private static ResourceKey<PaintingVariant> create(String pName) {
        return ResourceKey.create(Registries.PAINTING_VARIANT, ResourceLocation.fromNamespaceAndPath(WhimsyMod.MOD_ID, pName));
    }
    ...
    public static String getPaintingVariantTitleKey(String pName) {
        return "painting." + WhimsyMod.MOD_ID + "." + pName + ".title";
    }

    public static String getPaintingVariantAuthorKey(String pName) {
        return "painting." + WhimsyMod.MOD_ID + "." + pName + ".author";
    }
}
